...
def calculates_results_stats(results_dic):
    ...
    for pet_image in results_dic:
        ...
        if results_dic[pet_image][3]:
            n_dogs_img += 1
        else:
            n_notdogs_img += 1
            
        if results_dic[pet_image][2]:
            n_match += 1
            
        if results_dic[pet_image][3] and results_dic[pet_image][4]:
            n_correct_dogs += 1
        elif not results_dic[pet_image][3] and not results_dic[pet_image][4]:
            n_correct_notdogs += 1
        
        if results_dic[pet_image][3] and results_dic[pet_image][2]:
            n_correct_breed += 1
